    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (id)
        {
            case R.id.encryptmenu:
               // startActivity(new Intent(MainActivity2.this, decrypting.class));
                //Toast.makeText(getApplicationContext(),"dfb", Toast.LENGTH_LONG).show();
                return true;
            case R.id.decryptmenu:
                ...
                return true;
            default:
                //Toast.makeText(this, "nithing", Toast.LENGTH_SHORT).show();
