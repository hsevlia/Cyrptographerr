...
public class decrypting extends AppCompatActivity {

    private ActivityCryptBinding binding;
    ViewPager2 viewPager2 ;
    TabLayout tabLayout ;
    FragmentAdaptor1 adaptor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adaptor = new FragmentAdaptor1(fm,getLifecycle());
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (id)
        {
            case R.id.encryptmenu:
                 startActivity(new Intent(decrypting.this, MainActivity2.class));
